...
const Navbar = () => {
    return (
        <div className="nav flex bg-slate-900 text-white list-none justify-around p-4 ">
            ...
            <li>
            <li>
  <button class="flex items-center bg-green-700 text-white font-semibold py-2 px-4 rounded-2xl hover:bg-green-900 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-75">
    <svg
      class="w-3 h-4 mr-2"
      fill="currentColor"
      viewBox="0 0 24 24"
